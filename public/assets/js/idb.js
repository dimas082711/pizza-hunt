...
//this event will emit if the database version changes (nonexistant to version 1, b1 to v2, etc.)
...
request.onsuccess = function(event) {
    ...
    if (navigator.onLine) {
        //we havent created this yet, but we will soon, so let's comment it out for now
        uploadPizza();
    }
};
...
function uploadPizza() {
    ...
    getAll.onsuccess = function() {
        //if there was data in indexedDbs store, lets send it to the api server
